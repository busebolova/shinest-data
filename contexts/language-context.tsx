...
const translations = {
  TR: {
    ...
    "text.handwriting": "IŞIK TUTAR!", // Updated to all caps and removed "!" for consistency with user request
    "text.description":
    ...
    // Footer
    "footer.description": "Lüks iç mimarlık ve tasarım hizmetleri ile yaşam alanlarınızı sanat eserine dönüştürüyoruz.",
  ...
  EN: {
    ...
    // Footer
    "footer.description":
      "Transforming your living spaces into works of art with luxury interior architecture and design services.",
  ...
  DE: {
    ...
    // Footer
    "footer.description":
      "Verwandlung Ihrer Wohnräume in Kunstwerke mit luxuriösen Innenarchitektur- und Designdienstleistungen.",
  ...
  FR: {
    ...
    // Footer
    "footer.description":
      "Transformer vos espaces de vie en œuvres d'art avec des services d'architecture intérieure et de design de luxe.",
  ...
  IT: {
    ...
    // Footer
    "footer.description":
      "Trasformare i vostri spazi abitativi in opere d'arte con servizi di architettura d'interni e design di lusso.",
  ...
  RU: {
    ...
    // Footer
    "footer.description":
      "Превращение ваших жилых пространств в произведения искусства с помощью роскошных услуг дизайна интерьера.",
  ...
  AR: {
    ...
    // Footer
    "footer.description": "تحويل مساحات معيشتكم إلى أعمال فنية مع خدمات التصميم الداخلي والديكور الفاخر.",
