      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            disabled={githubStatus === "checking"}
            variant="outline"
            className="border-[#c4975a] text-[#c4975a] hover:bg-[#c4975a] hover:text-white bg-transparent"
          >
            <RefreshCw className={`w-4 h-4 mr-2 ${githubStatus === "checking" ? "animate-spin" : ""}`} />
            Senkronize Et
          </Button>
        </div>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              >
                {githubStatus === "connected" ? "Aktif" : githubStatus === "checking" ? "Kontrol Ediliyor" : "Pasif"}
              </span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="ml-2 font-medium">{githubStatus === "connected" ? "30 saniye" : "Durduruldu"}</span>
            </div>
          </div>
        </CardContent>
      </Card>
