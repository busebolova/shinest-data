      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">{t("aboutText")}</p>
            <div className="flex space-x-4">
              ...
              <a
                href="https://facebook.com/shinest.design"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <a href="mailto:info@shinest.com" className="text-white hover:text-amber-400 transition-colors">
                  info@shinest.com
                </a>
              </div>
              <div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">© 2024 SHINEST. {t("allRightsReserved")}</p>
        </div>
      </div>
    </footer>
  )
